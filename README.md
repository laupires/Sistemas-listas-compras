...
## Resumo
Este trabalho tem como proposta o desenvolvimento de um **Sistema de Lista de Compras**, com objetivo de ajudar na organização de casa de forma prática. A aplicação permitirá que o usuário registre os produtos que precisa comprar e visualize todos os itens em um só lugar. O sistema terá funcionalidades básicas, como : cadastrar itens, alterar quantidades, organizar por categorias, marcar produtos como comprados e edição ou exclusão de itens da lista.
